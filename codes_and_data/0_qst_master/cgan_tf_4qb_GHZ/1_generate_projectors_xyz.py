...
# Projectors for 1-qubits. Local unitaries:
...
################################################
# USE IN THE CASE OF ADDITION OF NOISE
...
ax.set_title('Expectation values for every measurement settings of simulation cGAN-1a - No addition of noise')
plt.legend(fontsize='20')
plt.xticks(fontsize='15')
plt.yticks(fontsize='15')
plt.xlabel("Measurement setting", fontsize='20')
